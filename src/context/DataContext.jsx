...
const DataContext = createContext(undefined);
 ...
 const initialCategories = [
  ...
  },
  {
    ...
    name: "Bracelets",
    slug: "bracelets",
    description: "Stunning bracelets that adorn your wrist with grace",
  ...
  },
  {
    ...
    name: "Earrings",
    slug: "earrings",
    description: "Elegant earrings that frame your face beautifully",
  ...
  },
  {
    ...
    name: "Necklaces",
    slug: "necklaces",
    description: "Timeless necklaces that make a statement",
...
export function DataProvider({ children }) {
  ...
  useEffect(() => {
    ...
    setProducts(savedProducts ? JSON.parse(savedProducts) : pro);
